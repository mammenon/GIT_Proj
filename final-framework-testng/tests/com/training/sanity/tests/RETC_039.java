...
{ 
	...
	categoriespage.enterName("New11 Launches");
	categoriespage.enterSlug("launch");
	categoriespage.enterDesc("New Launches of villas, apartments, flats");
	Thread.sleep(2000);
	...
	Thread.sleep(3000);
	allpostspage.sendTitle("New Launch");
	allpostspage.sendTextbox("New Launch in Home");
